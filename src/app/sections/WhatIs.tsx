        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <Card 
                key={index} 
                className="border border-slate-100 shadow-sm hover:shadow-md hover:bg-purple-50/80 transition-all duration-300 bg-white cursor-pointer group"
              >
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-slate-700 font-medium pt-2">{benefit}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
